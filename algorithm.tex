...
The final output of our algorithm is a segmentation of the two texts from the master-script and the transcript. We use this output in the \textit{compare view} to display the aligned segments side-by-side, and to accept into master-script.
