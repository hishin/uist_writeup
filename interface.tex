...
\begin{figure*}
  ...
  \caption{The \systemname\ interface. \VTODO{Add description.}}~\label{fig:ui_aligned}
\end{figure*}
...
The text appears in light grey to indicate that these parts have not been recorded yet (Figure~\ref{fig:ui_aligned} \textit{left}). At this stage, the master-script is like an ordinary, editable text document. \VTODO{There's an inconsistency! Below we say that grey text has been recorded but not yet accepted.}
